    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/caodangfptpolytechnic-lienhe-1.jpg');">
      ...
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <ol>
          ...
          <li style="color:white;">Môn học</li>
          <?php
        ...
        <div class="row gy-4">
          ...
          <?php if (($query1->rowCount() > 0)) {
            ...
            foreach ($results1 as $row) { ?>
              ...
              <?php $a = htmlentities($row->ghichu);

              if ($a == "Lab") { ?>
                <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="<?php echo $data ?>">
                  <div class="service-item  position-relative">
                    <div class="icon">
                      <i class="fa-solid fa-mountain-city"></i>
                    </div>

                    <h3><?php echo htmlentities($row->baitap); ?> <a href="<?php echo htmlentities($row->tailieu); ?>" download><i class="fas fa-download"></i></a></h3>
