...
<head>
    ...
    <title>CFF Thay đổi mật khẩu</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Mật khẩu cũ</label><input type="password" name="currentpassword" id="currentpassword" class="form-control" required=""></div>
                                    <div class="form-group"><label for="vat" class=" form-control-label">Mật khẩu mới</label><input type="password" name="newpassword"  class="form-control" required=""></div>
                                        <div class="form-group"><label for="street" class=" form-control-label">Nhập lại mật khẩu mới</label><input type="password" name="confirmpassword" id="confirmpassword" value=""  class="form-control"></div>
